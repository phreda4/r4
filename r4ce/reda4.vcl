...
Creating temporary file "C:\Windows\Temp\RSP793B.tmp" with contents
[
...
Creating command line "clarm.exe @C:\Windows\Temp\RSP793B.tmp" 
Creating temporary file "C:\Windows\Temp\RSP793C.tmp" with contents
[
...
Creating command line "link.exe @C:\Windows\Temp\RSP793C.tmp"
<h3>Output Window</h3>
Compiling resources...
Compiling...
graf.cpp
...
redalib.cpp
redam.cpp
C:\Documents and Settings\Administrador\Escritorio\r4\r4sources\r4cep\redam.cpp(329) : warning C4244: '=' : conversion from '__int64' to 'int', possible loss of data
StdAfx.cpp
Linking...
...
<h3>Results</h3>
reda4.exe - 0 error(s), 1 warning(s)
</pre>
</body>
</html>
